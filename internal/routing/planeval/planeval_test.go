...
func TestMeasureReadsPlanQuality(t *testing.T) {
	...
	backtracking := models.CalculatedRoute{
	...
	splitHousehold := models.CalculatedRoute{
	...
	empty := models.CalculatedRoute{Driver: &models.Driver{ID: 3, Lat: 0.01, Lng: 0.01}}
	result := &models.RoutingResult{Mode: models.RouteModeDropoff, Routes: []models.CalculatedRoute{backtracking, splitHousehold, empty}}
