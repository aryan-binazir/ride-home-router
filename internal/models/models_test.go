...
func TestRosterKeyMatchesEquivalentSpellings(t *testing.T) {
	tests := []struct {
		...
		{name: "acute", leftName: "O´Brien", leftAddr: "1 Main St", rightName: "OBrien", rightAddr: "1 Main St"},
		...
		{name: "name em dash", leftName: "Anne—Marie", leftAddr: "1 Main St", rightName: "Anne Marie", rightAddr: "1 Main St"},
		{name: "name soft hyphen", leftName: "Anne\u00adMarie", leftAddr: "1 Main St", rightName: "Anne Marie", rightAddr: "1 Main St"},
		{name: "name comma", leftName: "Smith,John", leftAddr: "1 Main St", rightName: "Smith John", rightAddr: "1 Main St"},
		{name: "name zero-width space boundary", leftName: "John\u200bSmith", leftAddr: "1 Main St", rightName: "John Smith", rightAddr: "1 Main St"},
		{name: "leading BOM", leftName: "\ufeffJohn Smith", leftAddr: "1 Main St", rightName: "John Smith", rightAddr: "1 Main St"},
		...
		{name: "address minus sign", leftName: "Jane Doe", leftAddr: "12−03 Main", rightName: "Jane Doe", rightAddr: "12-03 Main"},
...
func TestRosterKeyPreservesDistinctSpellings(t *testing.T) {
	tests := []struct {
		...
		{name: "okina distinguishes names", leftName: "Kaʻala", leftAddr: "1 Main St", rightName: "Kaala", rightAddr: "1 Main St"},
		{name: "zero-width space preserves boundary", leftName: "Jo\u200bAnn", leftAddr: "1 Main St", rightName: "Joann", rightAddr: "1 Main St"},
		{name: "hyphenated house number", leftName: "Jane Doe", leftAddr: "12-03 Main", rightName: "Jane Doe", rightAddr: "1203 Main"},
		{name: "soft hyphenated house number", leftName: "Jane Doe", leftAddr: "12\u00ad03 Main", rightName: "Jane Doe", rightAddr: "1203 Main"},
