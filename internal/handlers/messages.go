...
const (
	...
	messageDriverRestoreDuplicate                        = "A live driver with the same name and address already exists"
	...
	messageParticipantRestoreDuplicate                   = "A live participant with the same name and address already exists"
